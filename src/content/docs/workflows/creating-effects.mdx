...
- **Execution**: The side effect (logging to the console) encapsulated within `program` won't occur until the effect is explicitly [run](/workflows/running-effects). This allows you to define side effects at one point in your code and control when they are activated, improving manageability and predictability of side effects in larger applications.
...
<Aside type="tip">
  ...
  results (refer to [Running Effects](/workflows/running-effects#runsync) for
  more details).
</Aside>
...
Check out the next guide on [Running Effects](/workflows/running-effects) to find out more.

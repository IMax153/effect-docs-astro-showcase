...
For more detailed installation instructions on other platforms like Deno or Bun, you can refer to the [Quickstart](/getting-started/installation) tutorial.
...
So, let's take the first step and explore the fundamental concepts of the [The Effect Type](/getting-started/the-effect-type).

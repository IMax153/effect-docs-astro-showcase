...
```ts twoslash file=<rootDir>/control-flow/if-expr.ts
...
```ts twoslash file=<rootDir>/control-flow/if-expr-error-channel.ts
...
```ts twoslash file=<rootDir>/control-flow/when.ts#L1-L6
...
```ts collapse={1-6} file=<rootDir>/control-flow/when.ts
...
```ts twoslash file=<rootDir>/control-flow/whenEffect.ts
...
```ts twoslash file=<rootDir>/control-flow/if.ts
...
```ts twoslash file=<rootDir>/control-flow/zip.ts
...
```ts collapse={1-10} file=<rootDir>/control-flow/zip-concurrent.ts
...
```ts twoslash file=<rootDir>/control-flow/zipWith.ts
...
```ts twoslash file=<rootDir>/control-flow/loop.ts
...
```ts twoslash file=<rootDir>/control-flow/loop-discard.ts
...
```ts twoslash file=<rootDir>/control-flow/iterate.ts
...
```ts twoslash file=<rootDir>/control-flow/forEach.ts
...
```ts twoslash file=<rootDir>/control-flow/forEach-discard.ts
...
```ts twoslash file=<rootDir>/control-flow/all-tuples.ts

```

**Iterables**

```ts twoslash file=<rootDir>/control-flow/all-iterables.ts

```

**Structs**

```ts twoslash file=<rootDir>/control-flow/all-structs.ts

```

**Records**

```ts twoslash file=<rootDir>/control-flow/all-records.ts
...
```ts twoslash file=<rootDir>/control-flow/all-short-circuit.ts
...
```ts twoslash file=<rootDir>/control-flow/all-mode-either.ts
...
```ts twoslash file=<rootDir>/control-flow/all-mode-validate.ts

...
```ts file=<rootDir>/control-flow/if-expr.ts
...
```ts file=<rootDir>/control-flow/if-expr-error-channel.ts
...
```ts file=<rootDir>/control-flow/when.ts#L1-L6
...
```ts file=<rootDir>/control-flow/whenEffect.ts
...
```ts file=<rootDir>/control-flow/if.ts
...
```ts file=<rootDir>/control-flow/zip.ts
...
```ts file=<rootDir>/control-flow/zipWith.ts
...
```ts file=<rootDir>/control-flow/loop.ts
...
```ts file=<rootDir>/control-flow/loop-discard.ts
...
```ts file=<rootDir>/control-flow/iterate.ts
...
```ts file=<rootDir>/control-flow/forEach.ts
...
```ts file=<rootDir>/control-flow/forEach-discard.ts
...
```ts file=<rootDir>/control-flow/all-tuples.ts

```

**Iterables**

```ts file=<rootDir>/control-flow/all-iterables.ts

```

**Structs**

```ts file=<rootDir>/control-flow/all-structs.ts

```

**Records**

```ts file=<rootDir>/control-flow/all-records.ts
...
```ts file=<rootDir>/control-flow/all-short-circuit.ts
...
```ts file=<rootDir>/control-flow/all-mode-either.ts
...
```ts file=<rootDir>/control-flow/all-mode-validate.ts

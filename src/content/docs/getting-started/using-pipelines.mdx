...
```ts file=<rootDir>/using-pipelines/pipe.ts
...
```ts file=<rootDir>/using-pipelines/map.ts
...
```ts file=<rootDir>/using-pipelines/as.ts
...
```ts file=<rootDir>/using-pipelines/flatMap.ts
...
```ts file=<rootDir>/using-pipelines/array-flattening.ts
...
```ts file=<rootDir>/using-pipelines/andThen-with-option.ts
...
```ts file=<rootDir>/using-pipelines/andThen-with-either.ts
...
```ts file=<rootDir>/using-pipelines/tap.ts
...
```ts file=<rootDir>/using-pipelines/all.ts
...
```ts file=<rootDir>/using-pipelines/pipeline.ts
...
```ts file=<rootDir>/using-pipelines/pipe-method.ts#L17-

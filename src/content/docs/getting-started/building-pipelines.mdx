...
```ts file=<rootDir>/building-pipelines/pipe.ts
...
```ts file=<rootDir>/building-pipelines/map.ts
...
```ts file=<rootDir>/building-pipelines/as.ts
...
```ts file=<rootDir>/building-pipelines/flatMap.ts
...
```ts file=<rootDir>/building-pipelines/array-flattening.ts
...
```ts file=<rootDir>/building-pipelines/andThen.ts
...
```ts file=<rootDir>/building-pipelines/andThen-with-option.ts
...
```ts file=<rootDir>/building-pipelines/andThen-with-either.ts
...
```ts file=<rootDir>/building-pipelines/tap.ts
...
```ts file=<rootDir>/building-pipelines/all.ts
...
```ts file=<rootDir>/building-pipelines/pipeline.ts
...
```ts file=<rootDir>/building-pipelines/pipe-method.ts#L17-

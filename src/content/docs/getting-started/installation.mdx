...
```ts twoslash title="src/index.ts" file=<rootDir>/installation/hello-world.ts
...
```ts title="main.ts" file=<rootDir>/installation/hello-world.ts
...
```ts twoslash title="index.ts" file=<rootDir>/installation/hello-world.ts

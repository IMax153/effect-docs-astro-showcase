...
<Aside type="tip">
  ...
  Effects](/getting-started/running-effects#runsync) for more details).
</Aside>
...
<Aside type="tip">
  ...
  [zipping](/getting-started/control-flow#zipwith) for more details).
</Aside>
...
Check out the next guide on [Running Effects](/getting-started/running-effects) to find out more.

...
```ts file=<rootDir>/why-effect/divide.ts
...
```ts file=<rootDir>/creating-effects/succeed.ts
...
```ts file=<rootDir>/creating-effects/fail.ts
...
```ts file=<rootDir>/creating-effects/fail-with-custom-error.ts
...
```ts file=<rootDir>/creating-effects/fail-divide.ts
...
```ts file=<rootDir>/creating-effects/fail-user-retrival.ts
...
```ts file=<rootDir>/creating-effects/sync.ts
...
```ts file=<rootDir>/creating-effects/try.ts
...
```ts file=<rootDir>/creating-effects/promise.ts
...
```ts file=<rootDir>/creating-effects/tryPromise.ts
...
```ts file=<rootDir>/creating-effects/async.ts
...
```ts file=<rootDir>/creating-effects/suspend-lazy-evaluation.ts
...
```ts file=<rootDir>/creating-effects/suspend-circular-dependencies.ts
...
```ts file=<rootDir>/creating-effects/suspend-unifying-return-type.ts

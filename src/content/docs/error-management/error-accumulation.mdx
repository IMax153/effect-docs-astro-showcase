...
```ts file=<rootDir>/error-accumulation/zip.ts
...
```ts file=<rootDir>/error-accumulation/forEach.ts
...
```ts file=<rootDir>/error-accumulation/validate.ts
...
```ts file=<rootDir>/error-accumulation/validateAll.ts
...
```ts file=<rootDir>/error-accumulation/validateFirst.ts
...
```ts file=<rootDir>/error-accumulation/partition.ts

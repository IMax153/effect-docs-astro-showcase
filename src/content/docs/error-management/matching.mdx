...
```ts twoslash file=<rootDir>/matching/match.ts
...
```ts twoslash file=<rootDir>/matching/match-ignore.ts
...
```ts twoslash file=<rootDir>/matching/ignore.ts
...
```ts twoslash file=<rootDir>/matching/matchEffect.ts
...
```ts twoslash file=<rootDir>/matching/matchCauseEffect.ts

...
```ts twoslash file=<rootDir>/parallel-and-sequential-errors/first-error.ts
...
```ts twoslash file=<rootDir>/parallel-and-sequential-errors/parallel-errors.ts
...
```ts twoslash file=<rootDir>/parallel-and-sequential-errors/parallelErrors.ts
...
```ts twoslash file=<rootDir>/parallel-and-sequential-errors/sequential-errors.ts

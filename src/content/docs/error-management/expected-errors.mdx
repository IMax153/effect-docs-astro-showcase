...
As we saw in the guide [Creating Effects](/getting-started/creating-effects), we can use the `fail` constructor to create an Effect
...
<Aside type="note" title="Discriminators">

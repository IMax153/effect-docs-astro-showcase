...
```ts twoslash collapse={1-21} {29-31} file=<rootDir>/expected-errors/catch-some-if-all.ts
...
```ts twoslash collapse={1-21} {25} file=<rootDir>/expected-errors/catchIf-guard.ts
...
```ts twoslash collapse={1-21} {27-29} file=<rootDir>/expected-errors/catchTag-all.ts

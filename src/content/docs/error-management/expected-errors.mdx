...
```ts file=<rootDir>/expected-errors/either-if.ts
...
```ts file=<rootDir>/expected-errors/either-match.ts
...
```ts file=<rootDir>/expected-errors/catchAll.ts
...
```ts file=<rootDir>/expected-errors/catch-some-if-http-error.ts
...
```ts file=<rootDir>/expected-errors/catch-some-if-all.ts
...
```ts file=<rootDir>/expected-errors/catchSome.ts
...
```ts file=<rootDir>/expected-errors/catchIf.ts
...
```ts {25} file=<rootDir>/expected-errors/catchIf-guard.ts
...
```ts file=<rootDir>/expected-errors/catchTag-http-error.ts
...
```ts {27-29} file=<rootDir>/expected-errors/catchTag-all.ts
...
```ts file=<rootDir>/expected-errors/catchTags.ts

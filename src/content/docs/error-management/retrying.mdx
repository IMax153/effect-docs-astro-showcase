...
```ts file=<rootDir>/retrying/simulation.ts
...
```ts twoslash collapse={3-15} file=<rootDir>/retrying/retry.ts
...
```ts twoslash collapse={3-15} file=<rootDir>/retrying/retry-times.ts
...
```ts twoslash collapse={3-15} file=<rootDir>/retrying/retryOrElse.ts

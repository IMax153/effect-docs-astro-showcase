...
```ts twoslash file=<rootDir>/unexpected-errors/die.ts

```

**Example: `dieMessage`**

```ts twoslash file=<rootDir>/unexpected-errors/dieMessage.ts
...
```ts twoslash file=<rootDir>/unexpected-errors/orDie.ts
...
```ts twoslash file=<rootDir>/unexpected-errors/orDieWith.ts
...
```ts twoslash file=<rootDir>/unexpected-errors/exit.ts
...
```ts twoslash file=<rootDir>/unexpected-errors/catchAllDefect.ts
...
```ts twoslash file=<rootDir>/unexpected-errors/catchSomeDefect.ts

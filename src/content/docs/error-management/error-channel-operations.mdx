...
```ts file=<rootDir>/error-channel-operations/mapError.ts
...
```ts file=<rootDir>/error-channel-operations/mapBoth.ts
...
```ts file=<rootDir>/error-channel-operations/filter.ts
...
```ts file=<rootDir>/error-channel-operations/filter-type-guard.ts
...
```ts file=<rootDir>/error-channel-operations/tapError.ts
...
```ts file=<rootDir>/error-channel-operations/tapErrorTag.ts
...
```ts file=<rootDir>/error-channel-operations/tapErrorCause.ts
...
```ts file=<rootDir>/error-channel-operations/tapDefect.ts
...
```ts file=<rootDir>/error-channel-operations/tapBoth.ts
...
```ts file=<rootDir>/error-channel-operations/either.ts
...
```ts file=<rootDir>/error-channel-operations/cause.ts
...
```ts file=<rootDir>/error-channel-operations/merge.ts
...
```ts file=<rootDir>/error-channel-operations/flip.ts

...
```ts twoslash title="src/index.ts" file=<rootDir>/quickstart/hello-world.ts
...
```ts title="main.ts" file=<rootDir>/quickstart/hello-world.ts
...
```ts twoslash title="index.ts" file=<rootDir>/quickstart/hello-world.ts

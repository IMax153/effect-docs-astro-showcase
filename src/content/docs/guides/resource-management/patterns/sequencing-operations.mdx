...
Effect offers a way to achieve this pattern using the [Effect.acquireRelease](/guides/resource-management/scope#defining-resources) function in combination with the [Exit](/other/data-types/exit) type.

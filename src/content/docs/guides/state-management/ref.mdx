...
You can also pass a `Ref` as a [service](/guides/context-management/services) to share state between different parts of your program. Let's see how this works:

...
The module provides a single `Terminal` [tag](/guides/context-management/services), which serves as the entry point to reading from and writing to standard input and standard output.

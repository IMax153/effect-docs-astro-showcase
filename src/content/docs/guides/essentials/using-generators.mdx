...
In the previous sections, we learned how to [create](/guides/essentials/creating-effects) effects and [execute](/guides/essentials/running-effects) them. Now, it's time to write our first simple program.
...
<Aside type="note" title="Optional Feature">
  ...
  the documentation about [Building Pipelines](/guides/essentials/using-pipelines) in Effect.
</Aside>
...
can explore the ["Error Management"](/guides/error-management/two-error-types)
section.
</Aside>

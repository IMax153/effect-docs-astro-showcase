...
```ts twoslash file=<rootDir>/essentials/succeed.ts
...
```ts twoslash file=<rootDir>/essentials/fail.ts
...
```ts twoslash file=<rootDir>/essentials/fail-with-custom-error.ts
...
```ts twoslash file=<rootDir>/essentials/fail-divide.ts
...
```ts twoslash file=<rootDir>/essentials/fail-user-retrival.ts
...
```ts twoslash file=<rootDir>/essentials/sync.ts
...
```ts twoslash file=<rootDir>/essentials/try.ts
...
```ts {6} twoslash file=<rootDir>/essentials/try-custom-error-handling.ts
...
```ts twoslash file=<rootDir>/essentials/promise.ts
...
```ts twoslash file=<rootDir>/essentials/tryPromise.ts
...
```ts {7} twoslash file=<rootDir>/essentials/tryPromise-custom-error-handling.ts
...
```ts twoslash file=<rootDir>/essentials/async.ts
...
```ts twoslash file=<rootDir>/essentials/suspend-lazy-evaluation.ts
...
```ts twoslash file=<rootDir>/essentials/suspend-circular-dependencies.ts
...
```ts twoslash file=<rootDir>/essentials/suspend-unifying-return-type.ts

...
<Aside type="caution">
  The `log` helper accelerates time using [TestClock](/guides/testing/testclock), which means it simulates the passing of time that would normally occur in a real-world application.
</Aside>

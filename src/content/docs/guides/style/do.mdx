...
Initially, you may come up with code that uses the standard `pipe` [method](/workflows/using-pipelines#the-pipe-method), but this approach can lead to excessive nesting and result in verbose and hard-to-read code:
...
For more information on how to use generators in Effect, you can refer to the [Using Generators in Effect](/workflows/using-generators) guide.

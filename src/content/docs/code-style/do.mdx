...
Initially, you may come up with code that uses the standard `pipe` [method](/getting-started/using-pipelines#the-pipe-method), but this approach can lead to excessive nesting and result in verbose and hard-to-read code:

...
Initially, you may come up with code that uses the standard `pipe` [method](/getting-started/building-pipelines#the-pipe-method), but this approach can lead to excessive nesting and result in verbose and hard-to-read code:
...
For more information on how to use generators in Effect, you can refer to the [Using Generators in Effect](/getting-started/using-generators) guide.

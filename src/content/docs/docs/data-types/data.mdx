...
that generate default implementations for [Equal](/docs/trait/equal) and [Hash](/docs/trait/hash), making equality
checks a breeze.
...
The `Data` module simplifies the process by providing a default implementation for both [Equal](/docs/trait/equal) and [Hash](/docs/trait/hash),

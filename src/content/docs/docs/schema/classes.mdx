...
Thanks to the implementation of [Data.Class](/docs/data-types/data#class), instances of your classes automatically support the [Equal](/docs/trait/equal) trait, which allows for easy comparison:

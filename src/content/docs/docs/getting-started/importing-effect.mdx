...
For more detailed installation instructions on other platforms like Deno or Bun, you can refer to the [Quickstart](/docs/getting-started/installation) tutorial.

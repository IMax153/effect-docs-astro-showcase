...
description: The create-effect-app CLI allow you to create a new Effect application using a default template or an example from a public Github repository. It is the easiest way to get started with Effect.
sidebar:
  order: 4
---
...
![create-effect-app](./create-effect-app.gif "Animated GIF demonstrating the interactive experience when create-effect-app is run in interactive mode")

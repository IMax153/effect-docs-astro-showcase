...
Yieldable Errors are special types of errors that can be yielded within a generator function used by [Effect.gen](/docs/getting-started/using-generators/).
The unique feature of these errors is that you don't need to use the [Effect.fail](/docs/getting-started/creating-effects/#fail) API explicitly to handle them.

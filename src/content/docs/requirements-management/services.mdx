...
```ts file=<rootDir>/services/Random.ts
...
```ts file=<rootDir>/services/using-Random-gen.ts
...
```ts file=<rootDir>/services/using-Random-pipe.ts
...
```ts file=<rootDir>/services/run-error.ts

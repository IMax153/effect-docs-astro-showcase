...
For examples of how to use Tags in creating a simple service, check out [Creating a Simple Service](/guides/context-management/services#creating-a-service).

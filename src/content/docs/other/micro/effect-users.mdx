...
The `MicroExit` type is a streamlined version of the [Exit](/other/data-types/exit) type, designed to capture the outcome of a `Micro` computation. It uses the [Either](/other/data-types/either) data type to distinguish between successful outcomes and failures:
...
The `MicroCause` type is a streamlined version of the [Cause](/other/data-types/cause) type.

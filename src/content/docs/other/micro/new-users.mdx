...
The `MicroExit` type is designed to capture the outcome of a `Micro` computation. It uses the [Either](/other/data-types/either) data type to distinguish between successful outcomes and failures:

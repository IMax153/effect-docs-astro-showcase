...
that generate default implementations for [Equal](/other/trait/equal) and [Hash](/other/trait/hash), making equality
checks a breeze.
...
The `Data` module simplifies the process by providing a default implementation for both [Equal](/other/trait/equal) and [Hash](/other/trait/hash),

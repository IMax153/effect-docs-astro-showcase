...
<Aside type="tip">
  ...
  Types](/code-style/branded-types)). Additionally, you may want to
...
<Aside type="tip">
  ...
  [`@effect/schema`](/schema/introduction) or similar alternatives such as
  `zod`.
</Aside>
...
<Aside type="caution" title="Ensuring Request Comparability">
  ...
  [Equals.equals](/trait/equal)) to identify and batch identical requests
  effectively.
</Aside>

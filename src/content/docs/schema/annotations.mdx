...
| `jsonSchema`       | Specifies annotations that affect the generation of [JSON Schema](/schema/json-schema) documents, customizing how schemas are represented.                                                                                                                              |
| `arbitrary`        | Configures settings for generating [Arbitrary](/schema/arbitrary) test data.                                                                                                                                                                                            |
| `pretty`           | Configures settings for generating [Pretty](/schema/pretty) output.                                                                                                                                                                                                     |
| `equivalence`      | Configures settings for evaluating data [Equivalence](/schema/equivalence).                                                                                                                                                                                             |
